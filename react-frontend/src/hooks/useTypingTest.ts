...
export const useTypingTest = (config: TestConfig) => {
  ...
  const handlePaste = (e: React.ClipboardEvent) => {
    e.preventDefault();
    triggerInteractionWarning('Pasting is disabled during the typing test.');
  };

  const handleCopy = (e: React.ClipboardEvent) => {
    e.preventDefault();
    triggerInteractionWarning('Copy is disabled during the typing test.');
  };

  const handleCut = (e: React.ClipboardEvent) => {
    e.preventDefault();
    triggerInteractionWarning('Cut is disabled during the typing test.');
  };

  const handleContextMenu = (e: React.MouseEvent) => {
    e.preventDefault();
    triggerInteractionWarning('Right-click is disabled during the typing test.');
  };
  ...
  const handleDrop = (e: React.DragEvent) => {
    e.preventDefault();
    triggerInteractionWarning('Drag and drop is disabled during the typing test.');
  };

  const triggerInteractionWarning = useCallback((message: string) => {
